...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-wisper-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7819&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-wisper-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-wisper` can be installed with:

```
conda install rb-wisper
```

It is possible to list all of the versions of `rb-wisper` available on your platform with:
